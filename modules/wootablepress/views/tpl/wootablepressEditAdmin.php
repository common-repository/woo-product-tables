									...
									<section class="settings-blocks">
										...
										<section class="row-settings-block" id="wtpb-tab-settings-features">
											...
											<div class="setting-wrapper setting-wrapper-inline setting-suboption <?php echo esc_attr($classHidden); ?>" data-main="settings[sorting_custom]">
												<div class="setting-label">
													<label>
														...
														<i class="fa fa-question woobewoo-tooltip" title="<?php echo esc_attr(__('Select Manual option if you want to add a sort by drag-n-drop from the admin table preview to the frontend.<br>If you select sort by category, products will be grouped by product category. If a product has several categories, the first category in alphabetical order will be considered the main one. If there are variations in the table, they will not be grouped.', 'woo-product-tables')); ?>"></i>
													</label>
												</div>
												<div class="setting-input">
													<?php 
											...
											<div class="setting-wrapper">
												<div class="setting-label">
													<label>
														<?php esc_html_e('Export to CSV', 'woo-product-tables'); ?>
														<i class="fa fa-question woobewoo-tooltip" title="<?php echo esc_attr('<div class="wtbpTooltipsWrapper"><div class="wtbpTooltipsText">' . __('Show Export to CSV button.', 'woo-product-tables') . '</div></div>'); ?>"></i>
													</label>
												</div>
												<div class="setting-check">
													<?php 
