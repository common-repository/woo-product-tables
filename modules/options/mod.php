			...
			$this->_options = DispatcherWtbp::applyFilters('optionsDefine', array(
				'general' => array(
					...
					'opts' => array(
						...
						'locale_sorting' => array(
							'label' => __('Locale based sorting', 'woo-product-tables'),
							'desc' => __('If your locale contains accented characters, the table sorting may not work correctly. In this case, enable this option.', 'woo-product-tables'),
							'def' => '0',
							'html' => 'checkboxHiddenVal'
						),
					),
